...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Plant</h2>
    </template>
      ...
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            <h3 class="text-lg font-medium mb-6">Edit Plant: {{ plant.name }}</h3>
            ...
            <div v-if="errors && Object.keys(errors).length > 0" class="mb-4">
              <div v-for="(error, key) in errors" :key="key" class="mb-2 p-3 bg-red-100 border border-red-400 text-red-700 rounded">
